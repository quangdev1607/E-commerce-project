		...
		<div className="w-full border  flex-auto">
			<main className="p-5 flex flex-col gap-y-6">
				<section className="flex items-center justify-between ">
					...
					<span className=" flex-3 uppercase text-[20px] font-semibold text-[#505050] text-center">
						Daily Deal
					</span>
				...
				<section>
					<img
						...
						src={dailyDealProduct?.thumbnail}
						alt="daily deal"
					/>
				</section>
				<section className="flex flex-col items-center gap-y-3">
					...
					{dailyDealProduct && (
						<span>{`${formatCash(dailyDealProduct.price.toString())} VNĐ`}</span>
					)}
				</section>
